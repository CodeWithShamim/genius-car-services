...
const PostData = () => {
    ...
    const onSubmit = (data) => {
        console.log(data);
        fetch("https://genius-car-services-100.herokuapp.com/services", {
                method: "POST",
                headers: {
    ...
    return ( <
        ...
        >
        <
        input className = "my-2" {...register("description", { pattern: /^[A-Za-z]+$/i }) }
        placeholder = "Description" /
        >

        <
        input type = "price" {...register("price", { min: 18, max: 99 }) }
        placeholder = "price" /
        >
        <

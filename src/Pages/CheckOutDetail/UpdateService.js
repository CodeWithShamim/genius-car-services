...
const UpdateService = () => {
    ...
    const onSubmit = (data) => {
        console.log(data);
        const url = `https://genius-car-services-100.herokuapp.com/services/${id}`;
        fetch(url, {
                method: "PUT",
                headers: {
    ...
    return ( <
        ...
        <
        input className = "my-2" {...register("name", { required: true, maxLength: 20 }) }
        placeholder = "Name" /
        >
        <
